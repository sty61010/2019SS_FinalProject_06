var coincollectState = {
    ...
    scoreboard:function(){
        ...
        scoreText4 = game.add.text(750, 320, score4, { font: '30px Georgia', fill: '#fff' });
...
//special map
                else if(x==7 && y!=1 && y!=13 && y!=3 && y!=5 && y!= 9 && y!=11 )
                {
                    this.addWall(x, y);
                }
                else if(y==7 && x!=1 && x!=3 && x!= 5 && x!=9 && x!=11&& x!=13)
                {
                    this.addWall(x, y);
                }
                else if(x==3 && y==4 || x==4 && y==3 || x==4 && y==4 ){
                    this.addWall(x, y);
                }
                else if(x==10 && y==10 || x==10 && y==11 || x==11 && y==10){
                    this.addWall(x, y);
                }
                else if(x==3 && y==10 || x==4 && y==10 || x==4 && y==11 ){
                    this.addWall(x, y);
                }
                else if(x==11 && y==4 || x==10 && y==3 || x==10 && y==4 ){
                    this.addWall(x, y);
                }
                else if(x % 2 === 0 && y % 2 === 0){
                    this.addBrick(x,y);
    ...
    dropBomb: function(player){
        ...
        if(player == 1  && this.playerDrop){
            ...
            setTimeout(function(){
                ...
                coincollectState.enablePlayerBomb(3);
            }, 2000);
            setTimeout(this.thisEnableBomb, 2000);
            ...
            setTimeout(function(){
                ...
                coincollectState.enablePlayerBomb(4);
            }, 2000);
            setTimeout(this.thisEnableBomb, 2000);
        } 
    },
